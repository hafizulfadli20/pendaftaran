            ...
            <div class="col-md-12">
              <table class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td>1</td>
                    <td>Edi Siswanto</td>
                    <td>Wringin Rejo, Gambiran</td>
                    <td>90</td>
                    <td><span class="badge badge-info">BARU</span></td>
                    <td>
                        <a href="detailpendaftar.php" class="btn btn-primary btn-sm">Cek</a> 
                        <a href="" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>Alfian Jauhari</td>
                    <td>Kedung Rejo, Muncar</td>
                    <td>70</td>
                    <td><span class="badge badge-info">BARU</span></td>
                    <td>
                        <a href="detailpendaftar.php" class="btn btn-primary btn-sm">Cek</a> 
                  ...
                  <tr>
                    <td>3</td>
                    <td>Tahta Istiawan</td>
                    <td>Tembok Rejo, Muncar</td>
                    <td>80</td>
                    <td><span class="badge badge-info">BARU</span></td>
                    <td>
                        <a href="detailpendaftar.php" class="btn btn-primary btn-sm">Cek</a> 
