...
<head>
    ...
    <meta name="description" content="Website pendaftaran peserta didik baru secara online SMKN Darul Ulum Muncar">
    <meta name="author" content="EDT">
    <title>PPDB - SMKN DARUL ULUM MUNCAR</title>
...
<body>
    <header>
        <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow" style="background: white !important; height: 70px;">
            <div class="container">
                <a class="navbar-brand" href="#"><b>PPDB ONLINE</b></a>
    ...
    <main role="main" style="position: relative">
        <div class="container mt-5">
            <div class="row pt-5">
                <div class="col-md-7">
                    <h2 class="text-dark">PPDB ONLINE <br> SMK NEGERI DARUL ULUM <br> MUNCAR</h2>
                    <p class="lead">
        ...
        <p>
            &copy; 2017-2019 Company, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a>
        </p>
        </footer>
    </main>
